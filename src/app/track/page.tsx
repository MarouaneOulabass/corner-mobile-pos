      ...
      <main className="max-w-2xl mx-auto px-4 py-8">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
            <div className="flex-1">
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-[#2AA8DC] focus:ring-1 focus:ring-[#2AA8DC] transition"
                required
              />
            </div>
            <button
        ...
        {searched && repairs.length === 0 && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
            ...
            <p className="text-gray-600 font-medium">Aucune réparation trouvée pour ce numéro</p>
            <p className="text-gray-400 text-sm mt-1">Vérifiez le numéro et réessayez</p>
          </div>
        )}

        {repairs.map((repair) => (
          <div key={repair.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 mb-4 overflow-hidden">
            {/* Ready banner */}
            {repair.status === 'ready' && (
            ...
            <div className="p-6">
              ...
              <div className="flex items-start justify-between gap-4 mb-4">
                <div>
                  ...
                  <p className="text-gray-500 text-sm mt-0.5">{repair.problem}</p>
                </div>
                <span
              ...
              <div className="grid grid-cols-2 gap-4 mb-5 text-sm">
                <div>
                  ...
                  <p className="text-gray-900 font-medium">{formatDate(repair.created_at)}</p>
                </div>
                ...
                {repair.technician_name && (
                  <div>
                    ...
                    <p className="text-gray-900 font-medium">{repair.technician_name}</p>
                  </div>
                )}
              </div>
